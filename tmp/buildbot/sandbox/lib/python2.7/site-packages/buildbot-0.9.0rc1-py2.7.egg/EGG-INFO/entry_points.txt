...
BonsaiPoller = buildbot.changes.bonsaipoller:BonsaiPoller
...
StashStatusPush = buildbot.reporters.stash:StashStatusPush
...
MTR = buildbot.steps.mtrlogobserver:MTR
...
RpmSpec = buildbot.steps.package.rpm.rpmspec:RpmSpec
...
BuilderConfig = buildbot.config:BuilderConfig
...
CommandlineUserManager = buildbot.process.properties:CommandlineUserManager
...
EqConnectionPool = buildbot.steps.mtrlogobserver:EqConnectionPool
